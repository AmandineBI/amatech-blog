...
function publish(id) {
    Inertia.patch(route('publish', id));
}
</script>
        ...
        <div v-if="$page.props.auth.user?.is_admin">
            ...
            <div v-if="props.blog_posts">
                <div class="my-5 py-5 border-b-2 border-b-slate-200" v-for="post in props.blog_posts">
                    ...
                    <BreezeButton v-else class="inline-block px-4 py-2 cursor-default bg-gray-500 hover:bg-gray-500 text-white rounded mb-4">Publish post</BreezeButton>
