...
// Create a new material with an orange color
    ...
    <NavBarLayout-->
        ...
        <!--div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0"-->
            ...
            <!--div v-if="canLogin" class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                <Link :href="route('blog.index')" class="text-sm text-gray-700 dark:text-gray-500 underline mr-5">Blog</Link>
        ...
        <canvas class="v-screen h-screen" style="background-color: red" data-canvas></canvas>
        <div>hola</div>
